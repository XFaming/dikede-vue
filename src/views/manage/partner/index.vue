  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="partnerRef" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="密码" type="password" prop="password" v-if="form.id==null">
    ...
    <el-dialog title="合作商详情" v-model="partnerInfoOpen" width="500px" append-to-body class="custom-dialog">
      <el-row :gutter="20">
        <el-col :span="12">
          <div class="label">合作商名称：</div>
          <div class="value">{{ form.partnerName }}</div>
        </el-col>
        <el-col :span="12">
          <div class="label">联系人：</div>
          <div class="value">{{ form.contactPerson }}</div>
        </el-col>
      </el-row>
      <el-row :gutter="20">
        <el-col :span="12">
          <div class="label">联系电话：</div>
          <div class="value">{{ form.contactPhone }}</div>
        </el-col>
        <el-col :span="12">
          <div class="label">分成比例：</div>
          <div class="value">{{ form.profitRatio }}%</div>
        </el-col>
      </el-row>
    </el-dialog>
